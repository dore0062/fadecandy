...
void setup()
{
  // Update your matrix dimensions here
  int matrixWidth = 32;
  int matrixHeight = 32;
  
  // you may want to modify this to match the ratio of matrixWidth/matrixHeight
  size(300, 300, P3D);
  ...
  // set grid to match matrixWidth/matrixHeight, starting from the center, evenly spaced out across the window, zigzag/serpentineLayout=false
  opc.ledGrid(0, matrixWidth, matrixHeight, width * 1/2, height * 1/2,
              width/matrixWidth, height/matrixHeight, 0, false, false);
